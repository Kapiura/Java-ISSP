...
public class Main {
  ...
  static boolean
  isNegative(int[] list) //  checks if list of integers is negative
  {
    for (int i : list) {
      if (i < 0) {
  ...
  static String isPalindorme(
      String word) // return short answer (yes, no) if word is a palindrome
  {
    String ans = "Yes";
  ...
  public static void main(String[] args) {
    ...
    for (String word : words) {
      System.out.println("Is \"" + word + "\" palindorme? " +
                         isPalindorme(word));
    }
    // Task 3
    System.out.println("\nTask 3");
